        ...
        <div className="bg-muted/50 rounded-lg p-4 mb-6">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2">
              <span>✓</span> Simple meal preparation
            </li>
            <li className="flex items-center gap-2">
              <span>✓</span> Cutting, chopping, cooking
            </li>
            <li className="flex items-center gap-2">
              <span>✓</span> Clean up after cooking
            </li>
            <li className="flex items-center gap-2 text-amber-600">
              <span>⚠️</span> You provide the ingredients
            </li>
            <li className="flex items-center gap-2 text-muted-foreground">
              <span>💡</span> Great for ugali, rice, simple stews
            </li>
          </ul>
        </div>

        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
          <h4 className="font-medium text-amber-800 mb-2">Before You Book:</h4>
