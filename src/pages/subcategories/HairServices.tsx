...
const HairServices = () => {
  ...
  const vendors = getVendorsByCategory("Hair Services");
    ...
    <div className="min-h-screen bg-background">
      <div className="container px-4 py-6 max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold">💇‍♀️ Hair Services</h1>
            <p className="text-muted-foreground">Braids, weaving & styling</p>
          </div>
        </div>
