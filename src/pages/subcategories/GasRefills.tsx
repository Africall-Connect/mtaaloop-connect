...
const GasRefills = () => {
  ...
  const vendors = getVendorsByCategory("Gas Refills");
    ...
    <div className="min-h-screen bg-background">
      <div className="container px-4 py-6 max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold">🔥 Gas Refills</h1>
            <p className="text-muted-foreground">6kg & 13kg cylinder refills</p>
          </div>
        </div>
