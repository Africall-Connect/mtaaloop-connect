...
const LiquorWines = () => {
  ...
  const vendors = getVendorsByCategory("Liquor & Wines");
    ...
    <div className="min-h-screen bg-background">
      <div className="container px-4 py-6 max-w-4xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold">🍷 Liquor & Wines</h1>
            <p className="text-muted-foreground">Beer, wines & spirits (18+)</p>
          </div>
        </div>
